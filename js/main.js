document.addEventListener('DOMContentLoaded', () => {
    ...
    const allProducts = [
        ...
        { id: 'prod020', name: 'Bombillo R-15 Tricolor', price: 170, image: 'img/productos/bombillo-r-15-tricolor.webp', description: 'Contiene 100 piezas. El R-15, pero edición patriota con los 3 colores de la bandera.', classification: 'B', category: 'trueno' },
        ...
        { id: 'prod022', name: 'Bota Misil 25', price: 255, image: 'img/productos/bota-misil-25.webp', description: 'Contiene 4 piezas. Batería de pequeños silbatos que estallan en el cielo y se elevan con una luz plateada.', classification: 'B', category: 'aereo' },
        { id: 'prod023', name: 'Bota Misil 100', price: 300, image: 'img/productos/bota-misil-100.webp', description: 'Batería de pequeños silbatos que estallan en el cielo y se elevan con una luz plateada.', classification: 'B', category: 'aereo' },
        { id: 'prod024', name: 'Cara de Diablo', price: 300, image: 'img/productos/cara-de-diablo.webp', description: 'La cara de diablo es un artefacto explosivo que produce un trueno muy fuerte.', classification: 'A', category: 'trueno' },
        ...
        { id: 'prod037', name: 'Cosmopolitan', price: 1000, image: 'img/productos/cosmopolitan.webp', description: 'Batería profesional con 30 tiros de efectos variados y un espectáculo inolvidable. Duración de 35 segundos.', classification: 'C', category: 'profesional' },
        ...
        { id: 'prod040', name: 'Cuete Blanco', price: 120, image: 'img/productos/cuete-blanco.webp', description: 'Contiene 20 rollos. Este clásico se activa con un estallido seco y potente, que deja su marca en cualquier festejo. Reconocido por su sonido limpio y directo.', classification: 'B', category: 'trueno' },
        ...
        { id: 'prod042', name: 'Escupidor de Colores', price: 120, image: 'img/productos/escupidor-de-colores.webp', description: 'Contiene 12 piezas. El clásico escupidor que avienta bolas de colores secuenciales, ideal para los más peques.', classification: 'A', category: 'luz', imageFit: 'contain' },
        { id: 'prod043', name: 'Escupidor de Cracker', price: 120, image: 'img/productos/escupidor-de-cracker.webp', description: 'Contiene 12 piezas. El clásico escupidor que avienta bolas de tronidos secuenciales, ideal para los más peques.', classification: 'A', category: 'luz', imageFit: 'contain' },
        ...
        { id: 'prod048', name: 'Garra de Tigre', price: 170, image: 'img/productos/garra-de-tigre.webp', description: 'Contiene 20 piezas. Más grande que un bombillo, tiene un estruendo grande.', classification: 'B', category: 'trueno' },
        { id: 'prod049', name: 'Garra de Tigre Chica', price: 150, image: 'img/productos/garra-de-tigre-chica.webp', description: 'Contiene 50 piezas. Trueno medio/alto.', classification: 'B', category: 'trueno' },
        { id: 'prod050', name: 'Garra de Tigre Mega', price: 220, image: 'img/productos/garra-de-tigre-mega.webp', description: 'Contiene 20 piezas. Trueno fuerte.', classification: 'B', category: 'trueno' },
        ...
        { id: 'prod052', name: 'Hulk', price: 170, image: 'img/productos/hulk.webp', description: 'Contiene 20 piezas. Trueno fuerte.', classification: 'B', category: 'trueno' },
        { id: 'prod053', name: 'Hulk Chico', price: 150, image: 'img/productos/hulk-chico.webp', description: 'Contiene 50 piezas. Trueno medio fuerte.', classification: 'B', category: 'trueno' },
        { id: 'prod054', name: 'Hulk Mega', price: 220, image: 'img/productos/hulk-mega.webp', description: 'Contiene 20 piezas. Trueno muy fuerte.', classification: 'B', category: 'trueno' },
        ...
        { id: 'prod076', name: 'Vara Cobra', price: 60, image: 'img/productos/vara-cobra.webp', description: 'Contiene 10 piezas. Al encenderse, lanza destellos que se retuercen y giran en el aire, mientras silba (chiflador).', classification: 'A', category: 'aéreo', imageFit: 'contain' },
        { id: 'prod077', name: 'Vara Ever', price: 40, image: 'img/productos/vara-ever.webp', description: 'Contiene 10 piezas. La Vara Ever es perfecta para aquellos que buscan un espectáculo de luces en el cielo. Al encenderse, esta vara deja a su paso una serie de destellos brillantes y coloridos que iluminan la noche (chiflador).', classification: 'A', category: 'aéreo' },

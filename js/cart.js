document.addEventListener('DOMContentLoaded', () => {
    ...
    const clearCartButtonCatalog = document.getElementById('clear-cart-button-catalog');
        ...
        cart.forEach(item => {
            ...
            itemElement.innerHTML = `
                ...
                <div class="flex items-center space-x-2">
                    <button data-id="${item.id}" class="decrease-quantity-btn bg-gray-200 text-gray-700 px-2 py-1 rounded-md hover:bg-gray-300">-</button>
                    <span class="font-semibold text-sm">${item.quantity}</span>
                    <button data-id="${item.id}" class="increase-quantity-btn bg-gray-200 text-gray-700 px-2 py-1 rounded-md hover:bg-gray-300">+</button>
    ...
    if (clearCartButtonCatalog) {
        clearCartButtonCatalog.addEventListener('click', clearCart);
    }
